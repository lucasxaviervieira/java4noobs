...
public class Calculadora {
	public static void main(String args[]) {
		...
		System.out.println(
				"Digite soma para somar, subtracao para subtrair, divisao para dividir, multiplicacao, para multiplicar e mod para tirar o resto: ");
